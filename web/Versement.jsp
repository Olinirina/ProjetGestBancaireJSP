  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Nouveau Versement</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="col-sm-9">
                <form method="post" action="AjoutVersement">
                    <div alight="left">
                        <label class="form-label">Numero de versement</label>
                        <input type="text" class="form-control" placeholder="Numero de versement" name="numvers"  required/>
                    </div>
                    <div alight="left">
                    ...
                    <div alight="left">
                        ...
                        <input type="number" class="form-control" placeholder="Montant" name="montantvers"  required/>
                    </div>
                    <div alight="left">
                        <label class="form-label">Date</label>
                        <input type="Date" class="form-control" placeholder="Date" name="datevers"  required/>
                    </div>
                    <div alight="right">
...
myModal.addEventListener('shown.bs.modal', () => {
  myInput.focus();
        ...
        <div class="row">
            ...
            rs=stm.executeQuery("select * from versement");
            while(rs.next()){
                            ...
                            %>
                            <tr>
                                <td><%=rs.getString("NumVers")%></td>
                                <td><%=rs.getString("NumCompte")%></td>
                                <td><%=rs.getInt("MontantVers")%></td>
                                <td><%=rs.getString("DateVers")%></td>
                                <td><a href="ModifierVersement.jsp?id=<%=rs.getString("NumVers")%>">Modifier</a> </td>
                                <td><a href="SupprimerVersement.jsp?id=<%=rs.getString("NumVers")%>">Supprimer</a></td>
                            </tr>
